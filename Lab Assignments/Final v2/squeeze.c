...
/* This function 'squeezes' the input from main using a compression technique
   whereby, the input is a sequence of non-numeric characters where the same 
   character may be repeat. */
int squeeze(char inString[])
{
  /* Declare variables */
