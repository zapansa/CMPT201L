...
*/
void get_matrix(float matrix[MAX_SIZE][MAX_SIZE], int size);
...
*/
void get_m_diagonal(float matrix[MAX_SIZE][MAX_SIZE], int size);
...
/* This function multiplies all of the values of the
   ...
   is printed
*/
void get_s_diagonal(float matrix[MAX_SIZE][MAX_SIZE], int size);
...
*/
void get_col_sums(float matrix[MAX_SIZE][MAX_SIZE], int size);
...
*/
void print_col_sums(float colSums[], int size);
...
void get_s_diagonal(float matrix[MAX_SIZE][MAX_SIZE], int size)
{
  ...
  printf("The product of the elements on the secondary diagonal is: %f\n", prod);
}
...
void print_col_sums(float colSums[], int size)
{
  ...
  for(i=0; i<size; i++)
    printf("The sum of elements on column %d is: %f\n", i+1, colSums[i]);
}
